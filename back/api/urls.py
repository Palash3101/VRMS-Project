...
from .views import user_views, admin_views, notification_views, customer_views
...
urlpatterns = [
    ...
    path('admin/customers/', customer_views.CustomerListView.as_view(), name='customer_list'),
]